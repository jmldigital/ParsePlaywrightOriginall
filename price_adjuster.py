...
#             # logger.info(f"competitor1 row {row[competitor1]}")
#             # logger.info(f"competitor1_delivery {competitor1_delivery}")
...
#                     logger.info(f"corrected_prices {corrected_prices}")
#                 else:
#                     corrected_prices.append(our_price)
...
def adjust_prices_and_save(df, output_file):
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            # logger.info(f"our_price (сырой): {raw_price}")
